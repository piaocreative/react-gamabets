...
import { SingleGameNav, BottomNavigationBar, CenterGameCard } from '../../components';
import { numberIcon, bankIcon, codeIcon, avatarIcon } from '../../src/customIcons';

import paytmImage from '../../public/assets/paytm-512.png';

import styles from './morninggamabetdashboard.module.css'
    ...
    return <div >
        ...
        <Grid container spacing={1}>
            {gameList.map((indvGame, index) => {
                ...
                return (
                    // <CenterGameCard  gameDetails={indvGame} />
                    <Grid item xs={12} key={indvGame.gameTitle + index} >
                        <CenterGameCard gameDetails={indvGame} handlePlayClick={handlePlayClick} />
                    </Grid>
                )
            })
            }
...
export default MorningGamabetDashboard;