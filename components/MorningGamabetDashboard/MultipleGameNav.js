...
const MultipleGameNav = ({ }) => {
    ...
    return (
        <Card elevation={0} sx={{ borderRadius: '0 0 35px 35px', backgroundColor: '#FFDFD4', paddingBottom: '21px' }}>
            ...
            <Card elevation={3} sx={{ borderRadius: '17px', backgroundColor: theme=>theme.palette.primary.main,paddingTop:'16px', paddingLeft:'19px', paddingBottom: '9px' }}>
                {/* <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}> */}
                    
                <Typography
                            sx={{ color: '#fff', fontSize: '18px', lineHeight: '20px', fontWeight: 300, }}
                        >
                            Let's Start Playing Now
                        </Typography>
                        <Typography
                            sx={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '14px', lineHeight: '20px', fontWeight: 300, marginBottom: '14px' }}
                        >
                    ...
                    <Box sx={{ display: 'flex', justifyContent:'center' }}>
                        ...
                        <Typography
                            sx={{ color: '#fff', fontSize: '14px', lineHeight: '19px', fontWeight: 300, marginLeft: '7px' }}
                        >
                            9000190001
                        </Typography>
                    </Box>
