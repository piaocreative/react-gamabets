        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={6}>
            <FormGroup sx={{ fontSize: '12px' }}>
              <FormControlLabel control={<Checkbox />} label="Add Odd Digits" sx={{ '& .MuiFormControlLabel-label': { fontSize: 12 } }} />
            </FormGroup>
          </Grid>
          <Grid item xs={6}>
            <FormGroup sx={{ fontSize: '12px' }}>
              <FormControlLabel control={<Checkbox />} label="Add Even Digits" sx={{ '& .MuiFormControlLabel-label': { fontSize: 12 } }} />
            </FormGroup>
          </Grid>
          <Grid item xs={4}>
            <Typography
