...
const ChoicePanna = ({
  ...
  const [bidDigit1, setBidDigit1] = useState("");
  const [bidDigit2, setBidDigit2] = useState("");
  const [bidDigit3, setBidDigit3] = useState("");
  ...
  const createBid = async (event) => {
    ...
    if (!gameTypeKey) {
      ...
      msg = "Please Enter Left Digit!!!";
    } else if (!bidDigit2) {
      msg = "Please Enter Middle Digit!!!";
    } else if (!bidDigit3) {
      msg = "Please Enter Right Digit!!!";
    } else if (!bidPoints) {
    ...
    console.log('------  game id: ', gameIdDetails);
    if (!gameIdDetails) {
    ...
    setBidList([
      ...bidList,
      {
        digits: Number(bidDigit1.toString() + bigDigit2.toString() + bidDigit3.toString()),
        gameDate: selectedGameDate.date,
  ...
  const setNumValue = (key, value) => {
    ...
    if (key === "bidDigit1" && value.length > 1) return;
    if (key === "bidDigit2" && value.length > 1) return;
    if (key === "bidDigit3" && value.length > 1) return;

    if (key === "bidDigit1") {
      setBidDigit1(value);
    } else if (key === "bidDigit2") {
      setBidDigit2(value);
    } else if (key === "bidDigit3") {
      setBidDigit3(value);
  ...
  return (
    <div>
      ...
      <CommonDialog
        ...
        open={openGameSelect}
        handleClose={handlCloseGameSelect}
      >
        <Grid container spacing={2}>
          {Object.keys(gameTypeList).map((k) => (
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              id="select-game-type"
              // label=""
              value={gameTypeKey ? `${providerName} ${gameTypeKey}` : ""}
          ...
          <Grid item xs={4}>
            <FormGroup sx={{ fontSize: '12px' }}>
              <FormControlLabel control={<Checkbox />} label="SP" sx={{ '& .MuiFormControlLabel-label': { fontSize: 12 } }} />
            </FormGroup>
          </Grid>
          <Grid item xs={4}>
            <FormGroup sx={{ fontSize: '12px' }}>
              <FormControlLabel control={<Checkbox />} label="DP" sx={{ '& .MuiFormControlLabel-label': { fontSize: 12 } }} />
            </FormGroup>
          </Grid>
          <Grid item xs={4}>
            <FormGroup sx={{ fontSize: '12px' }}>
              <FormControlLabel control={<Checkbox />} label="TP" sx={{ '& .MuiFormControlLabel-label': { fontSize: 12 } }} />
            </FormGroup>
          </Grid>
          <Grid item xs={4}>
            <Typography
            ...
            <TextField
              ...
              placeholder=""
              value={bidDigit1}
              onChange={(e) => setNumValue("bidDigit1", e.target.value)}
          ...
          <Grid item xs={4}>
            ...
            <TextField
              ...
              placeholder=""
              value={bidDigit2}
              onChange={(e) => setNumValue("bidDigit2", e.target.value)}
              //   onClick={handleOpenGameDetail}
              InputProps={{
                sx: {
                  borderRadius: "17px",
          ...
          <Grid item xs={4}>
            ...
            <TextField
              ...
              placeholder=""
              value={bidDigit3}
              onChange={(e) => setNumValue("bidDigit3", e.target.value)}
              //   onClick={handleOpenGameDetail}
              InputProps={{
                sx: {
                  borderRadius: "17px",
